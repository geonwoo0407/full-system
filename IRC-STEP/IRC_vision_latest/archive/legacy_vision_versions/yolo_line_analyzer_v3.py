...
class YoloLineAnalyzer(Node):
    ...
    def _analyze_line(
        ...
        # Current heading:
        # prefer reliable near fit.
        if near_fit is not None:
            heading_error = near_fit.angle_deg
            near_heading = near_fit.angle_deg
        else:
            heading_error = full_fit.angle_deg
            near_heading = full_fit.angle_deg
